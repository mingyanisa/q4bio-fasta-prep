CREATE OR REPLACE VIEW prj-int-dev-covid19-nf-gls.sarscov2_metadata.illumina_consensus_metadata
AS SELECT 
...
WHERE file_submitted LIKE '%_consensus.fasta.gz' AND T2.instrument_platform = "ILLUMINA" 
